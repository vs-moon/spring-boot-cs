...
public class ProcessingConfigClientCondition implements Condition {
    ...
    public boolean matches(@NonNull ConditionContext context, @NonNull AnnotatedTypeMetadata metadata) {
        ...
        return StringUtils.isBlank(issuanceCenter) || (issuanceCenter.equals(Boolean.FALSE.toString()));
    }
}
